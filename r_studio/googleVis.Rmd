...
(https://www.macromedia.com/support/documentation/en/flashplayer/help/settings_manager04.htm
See the googleVis package vignette for more details.
```{r resetOptions}
## Set options back to original options
options(op)
```
Note that you can use the options() command in your knitr file to switch between
